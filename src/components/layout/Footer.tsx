  ...
  return (
    <footer className="border-t border-border/50 bg-background">
      <div className="mx-auto max-w-7xl px-4 py-16">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-3 max-w-xs text-sm text-muted-foreground">
              Fotografka svateb, koncertů a portrétů. Zachycuji autentické
              momenty a emoce.
            </p>
            <p className="mt-2 max-w-xs text-xs italic text-primary/50">
              Zachycuji momenty, které vyprávějí váš příběh
            </p>
          </div>
        ...
        {/* Bottom */}
        <div className="mt-10 flex items-center justify-between border-t border-border/30 pt-6 text-xs text-muted-foreground">
          <span>&copy; {currentYear} {SITE_NAME}. Všechna práva vyhrazena.</span>
          <a
            href="#"
